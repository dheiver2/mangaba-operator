...
from .agent import A2AMangaba
from .agent_executor import MangabaExecutor
...
async def main(host: str = "localhost", port: int = 10000):
    """Starts the Mangaba Agent server."""
    try:
        ...
        agent_card = AgentCard(
            ...
            version="1.0.0",
            defaultInputModes=A2AMangaba.SUPPORTED_CONTENT_TYPES,
            defaultOutputModes=A2AMangaba.SUPPORTED_CONTENT_TYPES,
        ...
        request_handler = DefaultRequestHandler(
            agent_executor=MangabaExecutor(
                agent_factory=lambda: A2AMangaba.create(max_steps=3)
            ),
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Start Mangaba Agent service")
    parser.add_argument(
        "--host",
        type=str,
        default="localhost",
