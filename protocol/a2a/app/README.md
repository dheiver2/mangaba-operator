# Mangaba Agent with A2A Protocol

This is an experimental integration of the A2A protocol (https://google.github.io/A2A/#/documentation) with Mangaba AI, currently supporting only non-streaming mode.

## Prerequisites
- conda activate 'Your Mangaba AI python env'
...
3. Send tasks to Mangaba AI via A2A Client CLI or Register A2A Agent Server in UI
