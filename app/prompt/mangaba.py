...
Before each tool call, state in ONE short sentence why this tool now (your reasoning, then the call). Never call a tool that does not serve the current step of the task.
